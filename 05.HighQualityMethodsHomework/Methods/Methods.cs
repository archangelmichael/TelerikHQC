    ...
    public class Methods
    {
        ...
        private static void Main()
        {
            try
            {
                ...
                peter.OtherInfo = "From Sofia, born at 17.03.1992"; ////if you comment this line you get an exception

                Student stella = new Student() { FirstName = "Stella", LastName = "Markova" };
                stella.OtherInfo = "From Vidin, gamer, high results, born at 03.11.1993"; ////if you comment this line you get an exception
